...
export function SmallWindowOverlay() {
  ...
  return (
    <div
      ...
      className="motion-overlay-panel fixed inset-0 z-[70] flex items-center justify-center bg-[rgba(7,9,16,0.74)] px-6 py-8 backdrop-blur-md"
    >
      <div
        role="alert"
        aria-live="assertive"
        className="w-full max-w-[30rem] rounded-[28px] bg-[linear-gradient(180deg,rgba(52,56,72,0.98),rgba(35,38,51,0.98))] p-3 shadow-[0_30px_80px_rgba(0,0,0,0.42),inset_0_0_0_1px_rgba(255,255,255,0.08)]"
      >
        <div className="rounded-[20px] bg-[rgba(10,13,22,0.32)] px-6 py-5 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.05)]">
          ...
          <h2 className="mb-3 text-balance text-[22px] font-semibold leading-[1.12] text-[color:var(--text)]">
            howcode works best with a little more room.
          </h2>
          <p className="text-pretty text-[14px] leading-6 text-[color:var(--muted)]">
          ...
          <div className="mt-5 grid gap-2 rounded-2xl bg-[rgba(255,255,255,0.045)] p-3 text-[12px] leading-5 text-[color:var(--muted)] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.055)] sm:grid-cols-2">
            <div>
