...
const askQuestionsCardClass =
  'relative grid w-full content-start gap-1.5 rounded-t-lg rounded-b-none border border-[color:var(--border)] bg-[color:var(--panel)] px-3 pt-2.5 pb-3.5 shadow-none'
