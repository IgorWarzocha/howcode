...
export const featureStatusById = {
  ...
  "feature:header.project-switch": { status: "partial", label: "Partial" },
  "feature:header.thread-actions": { status: "partial", label: "Partial" },
  "feature:header.thread-run-action": { status: "partial", label: "Partial" },
  "feature:header.product-menu": { status: "partial", label: "Partial" },
