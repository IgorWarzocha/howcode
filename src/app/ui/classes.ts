...
export const panelChromeClass =
  "rounded-[18px] border border-[color:var(--border)] bg-[rgba(39,42,57,0.9)] shadow-[var(--shadow)] backdrop-blur-xl";

export const mainPanelClass = "min-h-0 overflow-auto px-5 pt-1 pb-6";
...
export const toolbarButtonClass =
  "inline-flex min-h-7 items-center gap-1.5 rounded-lg border border-transparent px-1.5 text-[13px] text-[color:var(--muted)] transition-colors duration-150 ease-out hover:bg-[rgba(255,255,255,0.04)] hover:text-[color:var(--text)]";

export const ghostButtonClass =
  "rounded-[10px] border border-transparent px-2 py-1 text-[13px] text-[color:var(--muted)] transition-colors duration-150 ease-out hover:bg-[rgba(255,255,255,0.04)] hover:text-[color:var(--text)]";
...
export const sidebarSectionLabelClass =
  "flex items-center justify-between px-1.5 pt-2 text-[13px] text-[color:var(--muted)]";
...
export const inlineCodeClass =
  "rounded-md bg-[rgba(114,120,152,0.18)] px-1.5 py-0.5 font-mono text-[12px] text-[color:var(--text)]";
