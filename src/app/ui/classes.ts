...
export const composerInlineConfirmButtonClass =
  'composer-footer-text motion-popover pointer-events-auto absolute right-0 bottom-0 z-40 inline-flex h-7 items-center rounded-lg border-0 bg-[color:var(--panel)] px-2 text-left whitespace-nowrap text-[color:var(--muted)] shadow-none transition-colors hover:bg-[color:var(--surface-hover)] focus-visible:bg-[color:var(--surface-hover)] focus-visible:outline-none'
