- Compact and expanded layouts both compose `BranchThreadGroupSection`; keep branch-row behavior there and layout-specific grouping in their composition files.
