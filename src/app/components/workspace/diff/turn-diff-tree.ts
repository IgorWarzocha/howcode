...
export function summarizeTurnDiffStats(files: ReadonlyArray<TurnDiffFile>): TurnDiffStat {
  return files.reduce(
    (acc, file) => ({
...
export function buildTurnDiffTree(files: ReadonlyArray<TurnDiffFile>): TurnDiffTreeNode[] {
