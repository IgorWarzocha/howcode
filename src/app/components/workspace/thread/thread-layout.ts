...
export const chatViewportClass = "mx-auto flex h-full w-[800px] max-w-full overflow-visible";
export const chatHiddenViewportClass = "mx-auto flex h-full w-[800px] max-w-full overflow-hidden";
