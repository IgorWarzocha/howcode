...
- Worktree teardown gates composer sends and terminal opens by canonical project path, then revalidates Git identity after session shutdown and at removal. Branch switching, worktree creation, merge, removal, and branch pruning serialize only their root-repository Git mutations.
